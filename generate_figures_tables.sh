...
# generate table IV
python eval_topk_precision.py --json ./results/a100_sampled/acc/combined_results.json
python eval_topk_precision.py --json ./results/a100_sampled/bitbsr/combined_results.json
popd

#! T5: search convergence
pushd $SPARSENE_AD_ROOT/sparsene/examples/src_fp32/acc/testbed/scripts/motivation_scripts/sc_search_6156plans
# /workspace/Sparsene-SC26-AD/sparsene/examples/src_fp32/acc/testbed/scripts/motivation_scripts/sc_search_6156plans
# plot fig14
