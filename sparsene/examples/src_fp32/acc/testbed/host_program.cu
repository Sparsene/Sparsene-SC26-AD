...
void ncu_test(int threadblock_num_x,
    ...
    acc_spmm_kernel_tf32tf32fp32<BLK_MNK, MMA_MNK, BLK_MMA_MNK, WARP_MNK, nmask_per_tile, tile_mco_val_size>
...
void repeat_test(int threadblock_num_x,
    ...
    struct timeval t1, t2;
    {
        for (int i = 0; i < warmup_time; i++) {
            acc_spmm_kernel_tf32tf32fp32<BLK_MNK, MMA_MNK, BLK_MMA_MNK, WARP_MNK, nmask_per_tile,
                                         tile_mco_val_size>
