...
__global__ void gemm_device(const T* Aptr) {
    ...
    Tensor gA = make_tensor(make_gmem_ptr(Aptr), make_shape(Int<m>{}, Int<k>{}),
...
int main(int argc, char** argv) {
    ...
    using TiledMMA = decltype(make_tiled_mma(mma_atom{}, MMA_EU_RepeatT{}));
    ...
    using G2SCopyA = decltype(make_tiled_copy(
      g2s_copy_atom{}, make_layout(make_shape(Int<8>{}, Int<4>{}), make_stride(Int<4>{}, Int<1>{})),
    ...
    using SmemLayoutAtom = decltype(composition(
      ...
      make_layout(make_shape(Int<16>{}, Int<32>{}), make_stride(Int<32>{}, Int<1>{}))));

    // using SmemLayoutAtom = decltype(
    //     make_layout(make_shape(Int<16>{}, Int<32>{}),
    //                 make_stride(Int<32>{}, Int<1>{})));
    using SmemLayoutA = decltype(tile_to_shape(SmemLayoutAtom{}, make_shape(Int<16>{}, Int<32>{})));
    printf("G2SCopyA: ");
    print(G2SCopyA{});
    printf("\n");
    printf("S2RCopyAtomA: ");
